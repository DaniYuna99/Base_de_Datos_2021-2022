...
/*1. Mostrar el nombre y apellidos de todos los afiliados que tengan una licencia que 
empieza por A.*/
		
/*2. Mostrar los nombres de los peces que se han capturado en los eventos celebrados 
...
/*3. Mostrar los eventos, el lugar y los cauces en los que se han celebrado eventos 
...
/*5. Mostrar todos los cauces en los que alguna vez algún afiliado ha pescado alguna 
vez un pez en solitario, siempre que el la relación talla/peso sea mayor que 3.*/
		
/*6. Mostrar el nombre y el apellido de los afiliados que han pescado algún pez en 
un evento y que en el campo de observaciones esté recogido que su hábitat es ríos.*/
		
/*7. Mostrar el nombre y el apellido del afiliado o afiliados que ha sido el primer 
avalador del afiliado con código 1000.*/
		
/*8. Mostrar los eventos que se han celebrado en un lugar en el que el campo de 
...
/*10. Mostrar el nombre y apellido del afiliado o afiliados que han quedado en 
