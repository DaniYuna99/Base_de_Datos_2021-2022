...
CONSTRAINT PK_codigo_pedido_y_codigo_producto PRIMARY KEY (codigo_pedido, codigo_producto)
...
ALTER TABLE CLIENTE
ADD CONSTRAINT FK_codigo_empleado_rep_ventas FOREIGN KEY (codigo_empleado_rep_ventas) REFERENCES EMPLEADO (codigo_empleado);

ALTER TABLE PEDIDO
ADD CONSTRAINT FK_codigo_cliente FOREIGN KEY (codigo_cliente) REFERENCES CLIENTE (codigo_cliente);

ALTER TABLE DETALLE_PEDIDO
ADD CONSTRAINT FK_codigo_pedido FOREIGN KEY (codigo_pedido) REFERENCES PEDIDO (codigo_pedido);

ALTER TABLE DETALLE_PEDIDO
ADD CONSTRAINT FK_codigo_producto FOREIGN KEY (codigo_producto) REFERENCES PRODUCTO (codigo_producto);

ALTER TABLE PAGO
ADD CONSTRAINT FK_codigo_cliente_pago FOREIGN KEY (codigo_cliente) REFERENCES CLIENTE (codigo_cliente);

ALTER TABLE EMPLEADO
ADD CONSTRAINT FK_codigo_oficina FOREIGN KEY (codigo_oficina) REFERENCES OFICINA (codigo_oficina);

ALTER TABLE EMPLEADO
ADD CONSTRAINT FK_codigo_jefe FOREIGN KEY (codigo_jefe) REFERENCES EMPLEADO (codigo_empleado);
